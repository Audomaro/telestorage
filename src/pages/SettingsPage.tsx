...
export default function SettingsPage({ onBack }: SettingsPageProps) {
  ...
  return (
    <Box sx={{ p: 3, maxWidth: 500, mx: 'auto', mt: 2, bgcolor: 'background.paper', borderRadius: 2, border: 1, borderColor: 'divider' }} data-testid="settings-page">
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        {!loaded ? (
          ...
          <>
        <Typography variant="subtitle1" sx={{ fontWeight: 700 }} color="primary.main">Apariencia</Typography>
        <Box>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 700 }} color="primary.main">Navegación</Typography>
        <Box>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 700 }} color="primary.main">Descargas</Typography>
        <Box>
        ...
        <Typography variant="subtitle1" sx={{ fontWeight: 700 }} color="primary.main">Avanzado</Typography>
        <Box>
