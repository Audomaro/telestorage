...
describe('LoginForm', () => {
  it('should show phone input initially', () => {
    render(<LoginForm onSendCode={() => {}} onVerifyCode={() => {}} onCheck2FA={() => {}} />)
  ...
  it('should call onSendCode when submitting phone', () => {
    ...
    render(<LoginForm onSendCode={onSendCode} onVerifyCode={() => {}} onCheck2FA={() => {}} />)
  ...
  it('should show code input after phone is submitted', () => {
    render(<LoginForm onSendCode={() => {}} onVerifyCode={() => {}} onCheck2FA={() => {}} codeHash="abc123" />)
    expect(screen.getByPlaceholderText(/código/i)).toBeDefined()
  })

  it('should show 2FA input when needed2FA is true', () => {
    render(<LoginForm onSendCode={() => {}} onVerifyCode={() => {}} onCheck2FA={() => {}} codeHash="abc123" needs2FA={true} />)
    expect(screen.getByPlaceholderText(/contraseña/i)).toBeDefined()
  })

  it('should show error message', () => {
    render(<LoginForm onSendCode={() => {}} onVerifyCode={() => {}} onCheck2FA={() => {}} error="Código incorrecto" />)
    expect(screen.getByText('Código incorrecto')).toBeDefined()
  })

  it('should show loading state', () => {
    render(<LoginForm onSendCode={() => {}} onVerifyCode={() => {}} onCheck2FA={() => {}} loading={true} />)
  ...
  it('should call onCheck2FA when submitting with needs2FA', () => {
    ...
    render(<LoginForm onSendCode={() => {}} onVerifyCode={() => {}} onCheck2FA={onCheck2FA} codeHash="abc123" needs2FA={true} />)
