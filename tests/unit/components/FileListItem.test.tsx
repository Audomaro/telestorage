...
describe('FileListItem', () => {
  it('should render file name', () => {
    render(<FileListItem file={mockFile} isReadOnly={false} onDownload={() => {}} onDelete={() => {}} />, { wrapper: Wrapper })
    expect(screen.getByText('foto.jpg')).toBeDefined()
  })

  it('should call onDownload when download button clicked', () => {
    const onDownload = vi.fn()
    render(<FileListItem file={mockFile} isReadOnly={false} onDownload={onDownload} onDelete={() => {}} />, { wrapper: Wrapper })
  ...
  it('should call onDelete when delete button clicked', () => {
    ...
    render(<FileListItem file={mockFile} isReadOnly={false} onDownload={() => {}} onDelete={onDelete} />, { wrapper: Wrapper })
    fireEvent.click(screen.getByTitle('Eliminar'))
    expect(onDelete).toHaveBeenCalledWith(mockFile)
  })

  it('should hide delete button when isReadOnly', () => {
    render(<FileListItem file={mockFile} isReadOnly={true} onDownload={() => {}} onDelete={() => {}} />, { wrapper: Wrapper })
