...
describe('Toolbar', () => {
  it('should show filter buttons', () => {
    render(<Toolbar viewMode="list" onViewModeChange={() => {}} filter="all" onFilterChange={() => {}} onUpload={() => {}} showUpload={true} />, { wrapper: Wrapper })
  ...
  it('should call onFilterChange when clicking filter', () => {
    ...
    render(<Toolbar viewMode="list" onViewModeChange={() => {}} filter="all" onFilterChange={onFilter} onUpload={() => {}} showUpload={true} />, { wrapper: Wrapper })
  ...
  it('should call onUpload when upload button clicked', () => {
    ...
    render(<Toolbar viewMode="list" onViewModeChange={() => {}} filter="all" onFilterChange={() => {}} onUpload={onUpload} showUpload={true} />, { wrapper: Wrapper })
    fireEvent.click(screen.getByText('Subir'))
    expect(onUpload).toHaveBeenCalled()
  })

  it('should hide upload button when showUpload is false', () => {
    render(<Toolbar viewMode="list" onViewModeChange={() => {}} filter="all" onFilterChange={() => {}} onUpload={() => {}} showUpload={false} />, { wrapper: Wrapper })
